...
// Functions to ask user which options and made conditional statements to ensure minimum option requirements were met.
function questions() {
  var isValid = false;
  do {
  ...
  // Generated password daiplay on the screen.
    var responses = {
      length: length,
...
// Functions join all the user responses and then creates the password.
...
// Password to generate with randomly choosen characters
